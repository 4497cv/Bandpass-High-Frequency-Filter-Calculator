...
import math
wb = load_workbook(filename = 'C:/Users/César/Desktop/BANDPASS.xlsx')
sheet_ranges = wb['Sheet1']

def N2_BW(order, w0, BW, system_impedance):
    g1 = sheet_ranges['B4'].value
    g2 = sheet_ranges['C4'].value
    ...
    print("                    _______C2________   ")
    print(" _______R__________|_______L2________|  ")
    print("|               |  |                 |  ")
    print("VDC             C1  L1               RL ")
    print("|               |  |                 |  ")
...
def N3_BW(order, w0, BW, system_impedance):
    g1 = sheet_ranges['B5'].value
    g2 = sheet_ranges['C5'].value
    g3 = sheet_ranges['D5'].value
    ...
    print("                    _______C2________   ")
    print(" _______R__________|_______L2________|____________  ")
    print("|               |  |                    |   |     | ")
...
def N4_BW(order, w0, BW, system_impedance):
    g1 = sheet_ranges['B6'].value
    g2 = sheet_ranges['C6'].value
    g3 = sheet_ranges['D6'].value
    g4 = sheet_ranges['E6'].value
    ...
    print("                    _______C2________        ________C4________        ")
    print(" _______R__________|_______L2________|_______|_______L4________|____   ")
    print("|               |  |                    |   |                       |  ")
    print("VDC             C1  L1                  C3  L3                     RL  ")
    print("|               |  |                    |   |                       |  ")
...
def BP_BUTTERWORTH_FILTER(order, BW, center_freq, system_impedance):
