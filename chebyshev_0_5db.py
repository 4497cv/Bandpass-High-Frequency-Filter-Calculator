...
def N2_BW(order, w0, BW, system_impedance):
    g1 = sheet_ranges['B29'].value
    g2 = sheet_ranges['C29'].value
...
def N3_BW(order, w0, BW, system_impedance):
    g1 = sheet_ranges['B30'].value
    g2 = sheet_ranges['C30'].value
    g3 = sheet_ranges['D30'].value
...
def N4_BW(order, w0, BW, system_impedance):
    ...
    g2 = sheet_ranges['C31'].value
    g3 = sheet_ranges['D31'].value
    g4 = sheet_ranges['E31'].value
...
def BP_CHEBYSHEV_0_5_DB_FILTER(order, BW, center_freq, system_impedance):
